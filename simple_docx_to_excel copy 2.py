...
class SimpleDocxToExcelApp:
    ...
    def process_file(self):
        ...
        try:
            ...
            if table_count > 0:
                ...
                sheets_processed, rows_deleted, dates_normalized, text_moved = self.remove_columns(self.excel_path)
    ...
    def remove_columns(self, excel_path):
        ...
        return sheets_processed, rows_deleted, dates_normalized + birth_dates_normalized + end_dates_normalized, text_moved
